                        ...
                        <Box rounded='xl' bg='hsl(240 10% 3.9%)'>
                            <Box bg="hsl(240 10% 3.9%)" pb={10}>
                                ...
                                <Text mt={5}
                                    ...
                                    fontSize={'md'}
                                >
                                    4. In your [Settings], [Webhooks], add a new endpoint for the webhook URL.
                                </Text>
                                ...
                                <Text mt={5}
                                    ...
                                    fontSize={'md'}
                                >
                                    5. In the searchbox, type 'rules' and click {' [FraudPrevention > Rules] '}, <br />
                                    make sure the first 3DS rule is enabled. I also turn on the second one <br />
                                    (recommended by Stripe). Make sure to block payments if CVC fails (check below)
                                </Text>
                                ...
                                <Text mt={5}
                                    ...
                                    fontSize={'md'}
                                >
                                    7. Create new product and copy the price ID in the <Code bg='transparent' border='1px solid rgb(255,255,255,0.3)' color='gray.200' px={3} rounded='lg'>Pricing.js</Code> file.
                                </Text>
                                ...
                                <Text mt={5}
                                    ...
                                    fontSize={'md'}
                                >
                                    8. In your [Developers], copy your public & pricate keys and add them to your .env file.
                                </Text>
                                ...
                                <Text mt={5}
                                    ...
                                    fontSize={'md'}
                                >
                                    9. To set up the webook locally, follow the steps in [Developers], <br />
                                    [Webhook], [Test in local env], After login to STRIPE CLI, use this <br />
                                    command to forward webhook event to our API:
                                </Text>

                                <CodeBlock code={stripeWebhook} />
