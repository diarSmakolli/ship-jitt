        ...
        <Box bg='#000'>
            ...
            <Container maxW='2xl'>
                ...
                <Box py={10}>
                    ...
                    <Text fontFamily={'Epilogue'} fontWeight={600} fontSize={'4xl'} color='gray.300' mt={3}>
                    ...
                    <Text fontFamily={'Epilogue'} fontSize={'xl'} color='gray.300' mt={5} fontWeight={600}>
                        1. Grant of License
                    </Text>
                    ...
                    <Text fontFamily={'Epilogue'} fontSize={'md'} color='gray.300' mt={2} fontWeight={600}>
                    ...
                    <Text fontFamily={'Epilogue'} fontSize={'lg'} color='gray.300' mt={5} fontWeight={600}>
                        7. Entire Agreement
                    </Text>
