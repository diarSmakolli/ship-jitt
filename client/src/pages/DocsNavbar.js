                            ...
                            <Box bg="hsl(240 10% 3.9%)" pb={10}>
                                ...
                                {activeButton === 'button1' && (
                                    <Box position="relative" color="white" p="4" borderRadius="md">
                                        <Code display="block" whiteSpace="pre" width='100%' p={'2'} overflowX="auto" bg="rgb(24 24 27)" border='1px solid hsl(240 3.7% 15.9%)' borderRadius="md" color='gray.300'>
                                            <Image src={navbar} width='100%' height={'100%'} alt="Navbar" />
                                        </Code>
                                    </Box>
                                )}
