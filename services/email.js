                      ...
                      <tr>
                        <td class="content-cell">
                          <div class="f-fallback">
                            <h1>Hey,</h1>
                            <p>Thanks for using Ship-jitt. This email is the receipt for your purchase. No payment is due.</p>
                            <!-- Discount -->
                            <!--
                            ...
                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                              ...
                              <tr>
                                <td>
                                  <h3>Status</h3></td>
                                <td>
                                  <h3 class="align-right">${invoiceDetails.status}</h3></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  <h3 class="align-right">${invoiceDetails.paymentMethod}</h3></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  <h3 class="align-right">${invoiceDetails.planName}</h3></td>
                              </tr>
